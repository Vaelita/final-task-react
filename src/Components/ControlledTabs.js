  ...
  return (
    ...
    >
      <Tab eventKey="home" title="Who we are">
        <div className="tab-pane show active" id="home" role="tabpanel" aria-labelledby="home-tab">
          <div className="row">
            ...
            <div className="col-9">
              <p className="card-text">This page is designed to help you find the
              ...
              <p className="card-text">Feel free to let us know if there is anything we can help you with.</p>
            </div>
          </div>
        </div>
      </Tab>
      <Tab eventKey="profile" title="Profile">
        <div className="tab-pane show " id="profile" role="tabpanel" aria-labelledby="profile-tab">
          <div className="row">
            ...
            <div className="col-9">
              <p className="card-text">Our goal is to introduce you and help you practice some of the relaxation techniques.</p>
              <p className="card-text">Also, to remind you that it is okay to take time for yourself after a longer or shorter
      ...
      <Tab eventKey="contact" title="Contact">
        <div className="tab-pane show" id="contact" role="tabpanel" aria-labelledby="contact-tab">
          <div className="row">
            <div className="col-3">
              <img src={contacttab} alt="contact" />
            </div>
            <div className="col-9">
              <p className="card-text">Contact us by writing to our e-mail below, our online chat where we will try to answer
      ...
      <Tab eventKey="social" title="Social">
        <div className="tab-pane show" id="social" role="tabpanel" aria-labelledby="social-tab">
          <div className="row">
            <div className="col-3">
              <img src={socialtab} alt="social" />
            </div>
            <div className="col-9">
              <p class="card-text">You can also find us on <Link className="card-title" to="https://www.fb.com/">Facebook</Link>,
